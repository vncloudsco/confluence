...
CATALINA_OPTS="-Dcom.servicerocket.security.sso.support.enabled=true ${CATALINA_OPTS}"
CATALINA_OPTS="-Dcom.servicerocket.security.sso.support.enabled = false ${CATALINA_OPTS}"
